...
const allFrameworks = [
    ...
    { name: "Turborepo", icon: "logos:turborepo", type: "monorepo", desc: "High-performance build system for JavaScript and TypeScript monorepos." },
    { name: "Nx", icon: "logos:nx", type: "monorepo", desc: "Smart, fast and extensible build system with first-class monorepo support." },
    { name: "Lerna", icon: "logos:lerna", type: "monorepo", desc: "A tool for managing JavaScript projects with multiple packages." }
];
